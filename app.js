const structures={
 bead:{id:'BODY-BEAD-0001',name:'BEAD / ビードプレス',type:'BEAD',pitch:18,depth:1.2,lines:[124,132,140,148,156,164,172,180,188,196,204,212],note:'キハ54・211・719・東武10030など'},
 corrugate:{id:'BODY-CORR-0001',name:'CORRUGATE / コルゲート',type:'CORRUGATE',pitch:12,depth:2.5,lines:[118,130,142,154,166,178,190,202,214],note:'東武10000・京王7000初期・京成3500など'},
 susline:{id:'BODY-SUSLINE-0001',name:'SUS-LINE / 軽量ステンレス継ぎ目',type:'SUS_LINE',pitch:0,depth:.5,lines:[120,174,224],note:'E231・E233系統'},
 sustina:{id:'BODY-SUSTINA-0001',name:'SUSTINA / 完全平滑系',type:'SUSTINA',pitch:0,depth:0,lines:[108,238],note:'E235・東急2020系統'},
 smooth:{id:'BODY-SMOOTH-0001',name:'SMOOTH / 平滑',type:'SMOOTH',pitch:0,depth:0,lines:[108,238],note:'東急5000・TX系統'}
};
const bodies={
 kiha54:{id:'BODY-0001K',name:'キハ54形500番台 / MASTER-0001',dr:'DR-002',class:'Class21M-D',length:21300,width:2900,height:4000,doors:[5200,16100],windows:[1700,3000,7200,8800,10400,12000,13600,18900],pockets:[4750,5650,15650,16550],bogies:[3100,18200],type:'diesel',bogieType:'DIESEL',defaultStructure:'bead'},
 tokyu5000:{id:'BODY-0003A',name:'東急5000系 実測風',dr:'DR-003',class:'Class20M',length:20000,width:2800,height:4050,doors:[3000,8000,13000,18000],windows:[1350,4550,6250,9550,11250,14550,16250],pockets:[2450,3550,7450,8550,12450,13550,17450,18550],bogies:[2700,17300],type:'commuter',bogieType:'SS167',defaultStructure:'smooth'},
 e531:{id:'BODY-0004A',name:'E531系 近郊実測風',dr:'DR-004',class:'Class20M',length:20000,width:2950,height:4100,doors:[3300,8000,12600,17300],windows:[1350,5050,6500,9600,11100,14200,15700,18800],pockets:[2750,3850,7450,8550,12050,13150,16750,17850],bogies:[2800,17200],type:'suburban',bogieType:'DT71',defaultStructure:'susline'},
 e531g:{id:'BODY-0004G',name:'E531系 サロ二階建て風',dr:'DR-004A/B',class:'Class20M-G',length:20000,width:2950,height:4300,doors:[2700,17300],windows:[5200,7100,9000,10900,12800,14700],pockets:[2200,3200,16800,17800],bogies:[2800,17200],type:'green',bogieType:'TR255',defaultStructure:'susline'},
 tobu10030:{id:'BODY-0012B',name:'東武10030型 BEAD実証',dr:'DR-012',class:'Class20M',length:20000,width:2800,height:4050,doors:[3000,8000,13000,18000],windows:[1350,4550,6250,9550,11250,14550,16250],pockets:[2450,3550,7450,8550,12450,13550,17450,18550],bogies:[2800,17200],type:'commuter',bogieType:'SS167',defaultStructure:'bead'},
 corrDemo:{id:'BODY-CORR-DEMO',name:'コルゲート構体デモ',dr:'DR-CORR',class:'Class20M',length:20000,width:2800,height:4050,doors:[3100,8100,13100,18100],windows:[1400,4700,6400,9700,11400,14700,16400],pockets:[2550,3650,7550,8650,12550,13650,17550,18650],bogies:[2800,17200],type:'commuter',bogieType:'FS777',defaultStructure:'corrugate'}
};
const fronts={kiha54:{id:'FRONT-K54',name:'キハ54前面'},tokyu:{id:'FRONT-TOKYU5000',name:'東急5000系前面風'},e531:{id:'FRONT-E531',name:'E531系前面風'},a771:{id:'FRONT-A771',name:'A771系前面'},flat:{id:'FRONT-FLAT',name:'構体デモ用'} };
const roofs={diesel:{id:'ROOF-K54',name:'キハ54屋根 / 冷房・排気',cooler:'AU系',pantographs:[],vFacilities:false,vents:true},commuter:{id:'ROOF-0100',name:'AU712集中冷房',cooler:'AU712',pantographs:[],vFacilities:false},a771:{id:'ROOF-A771-14',name:'A771屋根 / AU712 + PT',cooler:'AU712',pantographs:[3600,16400],vFacilities:true},e531:{id:'ROOF-0101',name:'E531屋根機器',cooler:'AU726',pantographs:[7200],vFacilities:true}};
const under={diesel:{id:'UNDER-K54',name:'キハ54気動車床下',items:['ENGINE','FUEL','GEAR','MR','AIR-TANK']},a771m:{id:'UNDER-A771-M',name:'A771 M車床下',items:['VVVF','MR','AIR-TANK','BRAKE']},e531m:{id:'UNDER-E531-M',name:'E531 M車床下',items:['VVVF','SIV','MR','AIR-TANK','BRAKE']},commuter:{id:'UNDER-COMMUTER',name:'通勤車床下',items:['VVVF','SIV','AIR-TANK','BRAKE']}};
const liveries={jrhok:{id:'LIVERY-K54-JRH',name:'JR北海道キハ54風',base:'#f7f8f7',stripe:'#ef4444',accent:'#111827',lower:'#ced6df'},odorail:{id:'LIVERY-0001',name:'小戸電鉄標準',base:'#f8fbff',stripe:'#38bdf8',accent:'#22c55e',lower:'#344155'},wedding:{id:'LIVERY-0002',name:'Wedding-Liner',base:'#f8fbff',stripe:'#f9a8d4',accent:'#facc15',lower:'#313948'},steel:{id:'LIVERY-STAINLESS',name:'ステンレス素地',base:'#eef2f7',stripe:'#64748b',accent:'#94a3b8',lower:'#cbd5e1'}};
const vehicles=[
 {id:'MASTER-K54',name:'MASTER-0001 キハ54-500 BEAD構体',body:'kiha54',structure:'bead',front:'kiha54',roof:'diesel',under:'diesel',livery:'jrhok',service:'快速 / 北海道'},
 {id:'K54-ODORAIL',name:'キハA505-1 / 小戸標準',body:'kiha54',structure:'bead',front:'kiha54',roof:'diesel',under:'diesel',livery:'odorail',service:'普通 白夜中央'},
 {id:'TOBU10030',name:'東武10030型風 / BEAD展開',body:'tobu10030',structure:'bead',front:'tokyu',roof:'commuter',under:'commuter',livery:'steel',service:'普通'},
 {id:'CORR-DEMO',name:'コルゲート構体デモ',body:'corrDemo',structure:'corrugate',front:'flat',roof:'commuter',under:'commuter',livery:'steel',service:'CORRUGATE'},
 {id:'A771-M',name:'モハA771-1 / 平滑構体',body:'tokyu5000',structure:'smooth',front:'a771',roof:'a771',under:'a771m',livery:'wedding',service:'WEDDING-LINER'},
 {id:'E531-M',name:'モハE531風 / SUS-LINE',body:'e531',structure:'susline',front:'e531',roof:'e531',under:'e531m',livery:'odorail',service:'普通'}
];
...
function init(){const vs=$('vehicleSelect');vehicles.forEach((v,i)=>{const o=document.createElement('option');o.value=i;o.textContent=v.name;vs.appendChild(o)});fillSelect('bodySelect',bodies);fillSelect('structureSelect',structures);fillSelect('frontSelect',fronts);fillSelect('roofSelect',roofs);fillSelect('underSelect',under);fillSelect('liverySelect',liveries);vs.onchange=()=>{state={...vehicles[+vs.value]};sync();render()};['body','structure','front','roof','under','livery'].forEach(key=>{$(key+'Select').onchange=e=>{state[key]=e.target.value;if(key==='body'&&bodies[state.body].defaultStructure){state.structure=bodies[state.body].defaultStructure;sync()}render()}});$('demoBtn').onclick=()=>{state={...vehicles[0]};$('vehicleSelect').value=0;sync();render()};$('saveBtn').onclick=saveRvs;$('loadFile').onchange=loadRvs;$('pngBtn').onclick=exportPng;sync();render()}
function sync(){['body','structure','front','roof','under','livery'].forEach(k=>$(k+'Select').value=state[k]);}
function mmX(x,b){return 40+x/b.length*920}function mmW(w,b){return w/b.length*920}
function drawStructureLayer(b,s,l){let out='';
 if(s.type==='BEAD'){
  out+=`<g class="structure bead"><rect x="48" y="116" width="904" height="103" fill="url(#beadGrad)" opacity=".38"/>`;
  const ys=s.lines||[]; ys.forEach((y,i)=>{out+=`<path d="M52 ${y} H948" stroke="${i%2?'#ffffff':'#8fa1bc'}" stroke-width="${i%2?1:2}" opacity="${i%2?.75:.65}"/>`;});
  for(let y=122;y<218;y+=s.pitch){out+=`<line x1="54" y1="${y}" x2="946" y2="${y}" stroke="#cbd5e1" stroke-width="1" opacity=".35"/>`}
  out+='</g>';
 }
 if(s.type==='CORRUGATE'){
  out+=`<g class="structure corrugate">`;
  for(let y=118;y<218;y+=s.pitch){out+=`<path d="M52 ${y} H948" stroke="#64748b" stroke-width="2" opacity=".55"/><path d="M52 ${y+4} H948" stroke="#f8fafc" stroke-width="1" opacity=".65"/>`}
...
for(let cx of b.type==='diesel'?[490]:[310,690])svg+=drawCooler(cx-75,55,r.cooler);
if(r.vents){[360,640].forEach(x=>svg+=`<g><rect x="${x}" y="76" width="38" height="16" rx="4" fill="#8795aa" stroke="#334155"/><path d="M${x+6} 80 h26 M${x+6} 85 h26" stroke="#e5e7eb"/></g>`)}
(r.pantographs||[]).forEach(x=>{let px=mmX(x,b);svg+=drawPantograph(px,17);if(r.vFacilities)svg+=`<path d="M${px+35} 70 C${px+90} 45 ${px+210} 55 ${px+270} 70" fill="none" stroke="#1f2937" stroke-width="3"/>`;});
